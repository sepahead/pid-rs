...
pub mod experimental {
    ...
    pub mod schema3 {
        pub use crate::scientific::{
            ...
            ScientificMethodOrigin, ScientificOutcomeCoverage, ScientificOutcomeCoverageValidator,
            ScientificOutcomeReport, ScientificOutcomeStatus, ScientificOutputSchema,
            ScientificPipelinePlan, ScientificQuantityDefinition, ScientificReason,
            ScientificReasonCode, ScientificRegime, ScientificRegimeInputs, ScientificRequestEntry,
            ScientificRequestEntryInputs, ScientificRequestLedger, ScientificRequestVariable,
            ScientificSplitIdentity, ScientificSplitRole, ScientificSplitSelection,
            ScientificStageSet, ScientificStopStage, ScientificSupportIdentity,
            ScientificSupportStatus, ScientificTransformEdge, ScientificTransformFit,
            ScientificTransformFitPlan, ScientificTransformFitStatus, ScientificTransformKind,
            ScientificTransformPlanStep, ScientificUnit, ScientificValueSet, ScientificWarning,
            VersionedContentIdentity,
        };
    }
}

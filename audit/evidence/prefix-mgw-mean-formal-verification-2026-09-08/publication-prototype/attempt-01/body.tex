...
\subsection{1. Data, law and information question}\label{data-law-and-information-question}
...
\subsection{2. A node is a collection of alternatives}\label{a-node-is-a-collection-of-alternatives}
...
\subsection{3. What the prefix statistic observes}\label{what-the-prefix-statistic-observes}
...
\subsection{4. The finite coefficient identity}\label{the-finite-coefficient-identity}
...
\subsection{5. Expectations under the actual row law}\label{expectations-under-the-actual-row-law}
...
\subsection{6. Why the mean converges to the named atom}\label{why-the-mean-converges-to-the-named-atom}
...
\subsection{7. A sensor with no target information can give a positive short-prefix mean}\label{a-sensor-with-no-target-information-can-give-a-positive-short-prefix-mean}
...
\subsection{8. Edge cases and permitted interpretations}\label{edge-cases-and-permitted-interpretations}
...
\subsection{9. What this adds, and what must come next}\label{what-this-adds-and-what-must-come-next}

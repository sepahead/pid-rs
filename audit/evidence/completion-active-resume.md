...
[`4.33.0 current replay receipt`](lean-4.33.0-darwin-aarch64-current-project-replay-2026-08-13-r6.json).
...
are preserved as prior evidence, not current runner custody. Here `r6` denotes only the sixth

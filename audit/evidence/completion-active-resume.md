...
are preserved as prior evidence, not current runner custody. Here `r14` denotes only the fourteenth
receipt in the versioned sequence that originated on 12 August, and therefore the fifteenth

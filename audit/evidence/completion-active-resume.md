...
[`4.33.0 current replay receipt`](lean-4.33.0-darwin-aarch64-current-project-replay-2026-08-14-r8.json).
...
are preserved as prior evidence, not current runner custody. Here `r8` denotes only the eighth
receipt in the versioned sequence that originated on 12 August, and therefore the ninth

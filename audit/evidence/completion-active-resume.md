...
[`4.33.0 current replay receipt`](lean-4.33.0-darwin-aarch64-current-project-replay-2026-08-18-r10.json).
...
are preserved as prior evidence, not current runner custody. Here `r10` denotes only the tenth
receipt in the versioned sequence that originated on 12 August, and therefore the eleventh

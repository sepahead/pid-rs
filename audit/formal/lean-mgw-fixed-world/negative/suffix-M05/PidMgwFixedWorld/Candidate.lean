...
theorem cmi_different : Unit → PidMgwFixedWorld.RawTargets.CmiDifferent := fun (_ : Unit) => by
  change directCmi .irrelevant ≠ directCmi .completing
  rw [irrelevant_cmi, completing_cmi]

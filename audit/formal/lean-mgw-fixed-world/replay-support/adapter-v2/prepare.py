...
def main():
    ...
    for folder in load_roots:
        if not folder.exists() and not folder.is_symlink():
            # Preserve a nonexistent historical search component as an explicit
            # absence, rather than inventing or silently ignoring installed files.
            memberships[str(folder)] = None
            continue

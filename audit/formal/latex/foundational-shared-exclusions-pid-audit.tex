...
\path{audit/formal/lean-foundational-sxpid/PidDescriptorFactorization.lean}.
...
\path{audit/evidence/foundational-sxpid-descriptor-factorization-lean.json} and
...
\path{audit/tools/foundational_sxpid/check_lcr_relation_witness.py}

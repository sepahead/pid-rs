...
\hypersetup{colorlinks=true,linkcolor=PidPrimary,urlcolor=PidSecondary,citecolor=PidSecondary,pdftitle={Recorded office sensors: categorical shared exclusions},pdfauthor={pid-rs contributors},pdfsubject={A recorded-data example with signed MGW atoms and explicit continuous-support limits},pdfdisplaydoctitle=true}
\PidSetRunningHeads{Recorded office sensors}{Categorical MGW shared exclusions}
...
\title{\PidReportTitle{Recorded office sensors}{Categorical shared exclusions, signed contributions and continuous support}}

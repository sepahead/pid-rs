...
\hypersetup{colorlinks=true,linkcolor=PidPrimary,urlcolor=PidSecondary,citecolor=PidSecondary,pdftitle={Recorded office sensors: categorical shared exclusions},pdfauthor={Sepehr Mahmoudian},pdfsubject={A recorded-data example with signed MGW atoms and explicit continuous-support limits},pdfdisplaydoctitle=true}

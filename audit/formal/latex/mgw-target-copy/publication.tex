...
\hypersetup{colorlinks=true,linkcolor=PidPrimary,urlcolor=PidSecondary,citecolor=PidSecondary,pdftitle={Finite target-copy identities and entropy bounds for MGW synergy},pdfauthor={Sepehr Mahmoudian},pdfsubject={A finite probability example, signed atoms and scoped Lean verification},pdfdisplaydoctitle=true}

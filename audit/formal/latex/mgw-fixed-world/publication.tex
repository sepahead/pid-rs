...
\hypersetup{colorlinks=true,linkcolor=PidPrimary,urlcolor=PidSecondary,citecolor=PidSecondary,pdftitle={Same MGW synergy, different added information},pdfauthor={Sepehr Mahmoudian},pdfsubject={A finite probability example, signed atoms and scoped Lean verification},pdfdisplaydoctitle=true}
\PidSetRunningHeads{Same synergy, different added information}{Finite categorical MGW}
...
\title{\PidReportTitle{Same synergy, different added information}{A finite probability proof for categorical MGW shared exclusions}}

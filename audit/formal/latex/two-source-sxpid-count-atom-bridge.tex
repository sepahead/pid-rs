...
kernel replay, 71 registered static and baseline-first isolated changes, categorical-only scope
...
24 & Acceptance evidence & Exact kernel/source binding, 71 registered changes, categorical-only
...
theorems.  Under normal and optimized Python, the self-test rejects 40 static, five count/event,
...
These are not external review or independent authorship.  The exact hashes, commands, outcomes,
and residual cut are recorded in the revision-2 phase receipt.

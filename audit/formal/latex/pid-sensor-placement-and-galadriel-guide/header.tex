...
\fancyfoot[L]{\footnotesize\color{PidSlate}Sepehr Mahmoudian · 10 September 2026}
...
\renewcommand{\maketitle}{%
  ...
  \begin{titlepage}
    ...
    \begin{minipage}{0.88\textwidth}
      ...
      The Markdown and referenced SVG files are canonical. The PDF is a human-readable projection.

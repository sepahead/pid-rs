...
Lean & 4.33.0 & \path{audit/formal/lean/lean-toolchain} \\
mathlib & \path{v4.33.0} & \path{audit/formal/lean/lakefile.toml} \\
...
Qualification routes & Stable Rust CI, Rust 1.89 CI, 43 Rust tests, Clippy, rustdoc, static policy,
...
The backend pins Lean and mathlib 4.31.0.  The repository pins 4.33.0.  This mismatch blocks direct
integration.
...
a handwritten model, alter the Charon checkout, and compare Lean 4.31.0 with 4.33.0.  Rejection

...
\subsection{Why three-source MGW still matters}\label{why-three-source-mgw-still-matters}
...
\href{https://github.com/sepahead/pid-rs/blob/main/audit/formal/lean-finite-logscore/PUBLICATION.md}{Finite-law log-score package} & Four foundational and 13 conditional targets checked locally: posterior, Bayes score and MI/CMI gains & No mask/MGW formal bridge, portable or hosted replay, calibration or sensor benefit \\*

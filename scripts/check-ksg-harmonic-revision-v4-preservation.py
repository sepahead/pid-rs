...
EXPECTED_COMPONENT_SHA256 = {
    CURRENT_CATALOG_CHECKER_RELATIVE: (
        "84153d516d4de629d4e82f08e08a0cb4d02a9f4ddc53c060e71831b18600a840"
    ),
...
EXPECTED_COMPONENT_ROSTER_SHA256 = (
    "d9b371c4938147bc4385f68f0091de801ab0607c6f4ce8e7af5a78a768882809"
)
...
EXPECTED_CATALOG_STDOUT = {
    CURRENT_CATALOG_CHECKER_RELATIVE: (
        b"OK: 73 method entries and 45 references are coherent\n"
    ),
    CURRENT_CATALOG_SELF_TEST_RELATIVE: (

#!/usr/bin/env python3
"""Hostile tests for the mathematical-results guide hosted raw profile.

Pass the exact retained hosted fixture as the sole argument.  Every subprocess
...
CHECK_NAME = "Mathematical results guide hosted raw-profile self-test"
ROOT = pathlib.Path(__file__).resolve(strict=True).parent.parent
CHECKER = ROOT / "scripts/check-mathematical-results-guide-pdf-hosted-raw-profile.py"
...
def run_direct_stability_hostiles(
    ...
    unstable_dependency.write_bytes(b"x = 2\n")
    try:

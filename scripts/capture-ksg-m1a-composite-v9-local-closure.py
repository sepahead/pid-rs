...
if not (
    ...
    print(
        "ERROR: capture-ksg-m1a-composite-v9-local-closure.py requires Python 3.11+ -I -S -B",
        file=sys.stderr,
    )
    raise SystemExit(2)
...
def validate_record_value(value: Any) -> None:
    require(
        ...
        and value["schema"] == "pid-rs/ksg-rev4-m1a-composite-local-closure/v4"
        and value["schema_revision"] == 4
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(
            ...
            value = {
                ...
                "schema": "pid-rs/ksg-rev4-m1a-composite-local-closure/v4",
                "schema_revision": 4,
                "subject": {
                    "c8_parent": C8_COMMIT,

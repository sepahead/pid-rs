#!/usr/bin/env python3
"""Hostile tests for the 28-page mathematical-results guide hosted raw v5 profile.

Pass the exact retained locally captured v5 fixture as the sole argument.  Every subprocess
...
# Measured local translated Linux v5 fixture; inherited hostile controls unchanged.
...
CHECK_NAME = "Mathematical results guide hosted raw-profile v5 self-test"
ROOT = pathlib.Path(__file__).resolve(strict=True).parent.parent
CHECKER = ROOT / "scripts/check-mathematical-results-guide-pdf-hosted-raw-profile-v5.py"
...
EXPECTED_CHECKER_SHA256 = 'dfc8bceee72df9c7fc6d5d14abd75b92e901fdeda8dc55cc9d7134c5436a7719'
EXPECTED_HOSTED_FIXTURE_BYTES = 818_508
EXPECTED_HOSTED_FIXTURE_SHA256 = '09610708ae87e43b754a015480755b88e4cc2e299d5f1b427fb87c664dc27e64'
EXPECTED_STRUCTURE_CHECK_SHA256 = '9b0def2bc263aa5e406d432e9893a27f7f0d5098aaebae51d70a329830c4d21c'
...
# measured v5 contract bindings. These are not candidate-derived pins.
EXPECTED_CANONICAL_TARGETS_SHA256 = '181d7810ac7ac05597fe56de9c519fdf05f9c4c8bad778ec6fb6f6402ef2a444'
EXPECTED_CANONICAL_NAVIGATION_SHA256 = '88a424f3c51050a2d5af85d0303fee2b1849b1678a559648298fd021c12bce7b'
EXPECTED_CANONICAL_STRUCTURE_SHA256 = 'd8115d660de1bbfc2972e249429fab3d8ee383a2e981985b2b81ee7cd618f293'
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(
            ...
            require(
                ...
                "fixture target report differs from the independent v5 target observation",
            )
            require(
                ...
                "fixture reports differ from the bound v5 structure/navigation contract",
            )

...
HOSTILE_EVIDENCE_BLOCK_BEGIN = b"# BEGIN EXACT_LOG_HOSTILE_EVIDENCE_V2"
HOSTILE_EVIDENCE_BLOCK_END = b"# END EXACT_LOG_HOSTILE_EVIDENCE_V2"
EXPECTED_HOSTILE_EVIDENCE_BLOCK_SIZE_BYTES = 7197
EXPECTED_HOSTILE_EVIDENCE_BLOCK_SHA256 = (
    "0db9a2819c1136eca02df3d3ff2c7e26e4059a39c7b3c0b696851158a2265b55"
)
    ...
    mutations: list[tuple[str, Any, str]] = [
        ...
        (
            ...
            mutated_text(
                ...
                (
                    ...
                    "ksg-composite-v12-preservation certified-sxpid "
                    "citation-edge-countermodel "
                ),
                (
                    " formal-finite-convergence lean-toolchain-freeze "
                    "ksg-composite-v12-preservation citation-edge-countermodel "
                ),
            ),
        ...
        (
            ...
            mutated_text(
                ...
                "justfile",
                (
                    "lean-toolchain-freeze ksg-composite-v12-preservation certified-sxpid "

#!/usr/bin/env python3
"""Check the bound v4 raw hosted profile for the 28-page mathematical-results guide PDF.

This comparator is deliberately source-specific.  It binds one retained
locally captured Ubuntu/x86 candidate fixture by exact byte length and SHA-256.  The
...
# Measured local translated Linux v4 fixture; hosted replay remains separate.
...
CHECK_NAME = "Mathematical results guide hosted raw-profile v4 check"
...
# This is one frozen 28-page producer observation, not a generic toolchain family.

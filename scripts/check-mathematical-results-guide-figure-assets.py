...
EXPECTED_FIGURES = (
    ...
    },
    {
        ...
        "derivative_sha256": "bdd7694af0170f65367098d7feb7e316fd6c1e68d673fd6a433453b9908281ed",
        "pdf_bytes": 84999,
        "media_box_tokens": ["0", "0", "510.23622", "340.15748"],
        "css_family": "Source Sans Pro",
        "css_weights": {400, 600, 700},
        "font_inventory": [
            {"subtype": "Type1", "postscript_name": "SourceSansPro-Bold"},
...
EXPECTED_BINDINGS = {
    "regeneration_contract": {
        ...
        "sha256": "9918831ac46a02111b4f8116f9be97cc30e0661eb2d61d2c0d148ed064a104f8",
    },
    "regenerator": {
        "path": "scripts/regenerate-mathematical-results-guide-open-font-figures.py",
        "sha256": "8c45cc8c490db81f84084054549a7654a272abcdaecd897cf7fc80a0439d6d6a",
    },
    "third_party_notice": {

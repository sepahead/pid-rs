...
# fmt: off
EXPECTED_NORMALIZED_LEAN_CHECKER_SHA256 = "87dc45140c615b97e19cf56794333cdc064ea280957c17bec1984c3942805a3d"
# fmt: on
EXPECTED_VALIDATE_FRESH_REPLAY_SOURCE_SHA256 = (
    "cf543e5985faf2129b09809b0d4fd801ea9f19617b86cd4ee524608f2e74067a"
)
...
EXPECTED_LOCAL_CAPTURE_SOURCE_SHA256 = (
    "4cce26cbb0e668d0b72a077dd00a45ffd70e82dff0d705c4abe6973483f9d15f"
)
...
EXPECTED_SELF_TEST_BOOTSTRAP_SOURCE_SHA256 = (
    "c7baab53d780014459e598eb2cf92d11e2f33367ba43a9af8bf7523f7c876c32"
)
EXPECTED_SELF_TEST_MAIN_SOURCE_SHA256 = (
    "33979a957ff72b01d20c488ba611c342a6fb8379dfc3c131ed595430e4c28e67"
)
...
RECEIPT_NONIMPLICATIONS = [
    ...
    "The rejected candidate, not observed accepted or published on main as C9 in the bounded checks, and its archived r14 remain outside accepted replay and contribute no C9, R9, L9, hosted, scientific, qualification, or independence credit.",
...
POLICY_NONIMPLICATIONS = [
    ...
    "At the recorded observation, the mutable provider archive ref supplied a recovery locator for the rejected candidate and archived r14; it grants no C9, R9, L9, hosted, scientific, accepted-current-replay, or independence credit or durability claim.",
...
FROZEN_C9_PATH_BINDINGS: dict[str, tuple[str, int, str]] = {
    ...
    "AGENTS.md": (
        "0ba205c22e8304ce75445acc354778fe41456fc8881971d7219602e1e2bc3b11",
        69594,
        "100644",
    ),
    "CHANGELOG.md": (
        "c76749aa61addc3f610623783045bcff215b2957d3272da77054df67dc3a4d22",
        208741,
        "100644",
    ),
    "audit/evidence/completion-active-resume.md": (
        "ca0bd060d9897a9cc71f11015c9f0ee3d4eef444481890d3594c702bd05ec6a2",
        10292,
        "100644",
    ),
    "audit/evidence/ksg-rev4-m1a-composite-predecessor-failure-hosted-capture-v9-2026-08-19.json": (
        "03ce1e37586694f7e9c0fd2261f6fea992817e2f8bced585d287b538620dc23b",
        1850199,
        "100644",
    ),
    "audit/evidence/ksg-rev4-m1a-composite-v9-boundary-2026-08-19.md": (
        "fb6a46d7453cdb2f07a1b5467fd566d7cc9d48a4a8c0a8af2a5d1bf7542aecac",
        19252,
        "100644",
    ),
    "audit/evidence/ksg-rev4-m1a-composite-v9-path-policy-v1.json": (
        "b2cae04270a71e732341f8f71da5c0b5082d2a189bd1735b728b55b3844d3a2f",
        23535,
        "100644",
    ),
    "audit/evidence/wibral-pid-program-active-plan-2026-08-12.md": (
        "e3be4e7b329842717a127a1f3c857eb880177ecb306bf168a98340e61e8b3793",
        52628,
        "100644",
    ),
    "audit/formal/LEAN_4_33_FREEZE_AND_REPLAY.md": (
        "069ef6de2e562351fb5672551bd1cdcfdeb526c7cf414c7b611a911c842d5e73",
        26545,
        "100644",
    ),
    "audit/formal/TWO_SOURCE_SXPID_COUNT_ATOM_BRIDGE.md": (
    ...
    "scripts/README.md": (
        "9028ed9e80ae93bbeb56ba8178f240d95a9b05d08cae6730995cb25b24c1bed2",
        163740,
        "100644",
    ),
    ...
    "scripts/check-certified-sxpid2-claim.py": (
        "f7a22a294dff29cc2c6ddb66951a661583c8e0085388b9e0022320f2bff26853",
        82193,
        "100644",
    ),
...
def validate_policy_value(value: Any) -> None:
    ...
    require(
        ...
        == {
            ...
            "predicate": (
                "fresh_post_c8_r14_excluding_both_rejected_same_slot_r14_"
                "artifacts_from_current_and_prior_replay_and_current_source_"
                "match_c9"
            ),
            "retained_prior": {
                "path": R13_RELATIVE,
...
def validate_c9_narrative_boundaries(documents: dict[str, bytes]) -> None:
    ...
    for path in C9_NARRATIVE_PATHS:
        ...
        for required in (
            ...
            b"exclude both rejected same-slot artifacts",
...
def derive_receipt(
    ...
    result = {
        ...
        "replay": {
            ...
            "predicate": (
                "fresh_post_c8_r14_excluding_rejected_r14_from_current_and_"
                "prior_replay_and_current_source_match_c9"
            ),

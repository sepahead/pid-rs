...
# Source-specific v4 baseline measured independently; inherited hostile controls unchanged.
...
CHECKER_PATH = ROOT / "scripts/check-mathematical-results-guide-pdf-structure-v4.py"
...
def main(argv: list[str]) -> int:
    ...
    if len(baseline.targets) != 75 or len(baseline.navigation) != 285:

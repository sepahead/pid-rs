#!/usr/bin/env python3
"""Hostile tests for the 24-page mathematical-results guide hosted raw v3 profile.

Pass the exact retained locally captured v3 fixture as the sole argument.  Every subprocess
...
CHECK_NAME = "Mathematical results guide hosted raw-profile v3 self-test"
ROOT = pathlib.Path(__file__).resolve(strict=True).parent.parent
CHECKER = ROOT / "scripts/check-mathematical-results-guide-pdf-hosted-raw-profile-v3.py"
...
EXPECTED_CANONICAL_TARGETS_SHA256 = "1142501b51446aba6709e6bde2d3c7ad9c69e2df2f6701c4e7eee3615b5d0f2f"
EXPECTED_CANONICAL_NAVIGATION_SHA256 = "4d3914cf914496ed2aff921f8676cf39ce2b73161285e2164c10b83d825c1a44"
EXPECTED_CANONICAL_STRUCTURE_SHA256 = "7231f57e615831ab41d8070c2247b23b8bf2b80d8a4fcbeed737198bc24bd0f8"
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(
            ...
            require(
                ...
                "fixture target report differs from the independent current-v3 target observation",
            )
            require(
                ...
                "fixture reports differ from the unchanged current-v3 structure/navigation contract",
            )

#!/usr/bin/env python3
"""Check the one raw hosted profile for the mathematical-results guide PDF.

This comparator is deliberately source-specific.  It binds one retained hosted
fixture by exact byte length and SHA-256.  A distinct candidate is admitted only
...
The result is a bounded raw-profile comparison.  It is not general PDF
equivalence, raw-byte reproducibility across arbitrary producers, authenticity,
or permission to weaken the repository's exact-mode comparison.
"""
...
CHECK_NAME = "Mathematical results guide hosted raw-profile check"
...
# This is one frozen producer observation, not a generic toolchain family.
EXPECTED_HOSTED_FIXTURE_BYTES = 581_296
EXPECTED_HOSTED_FIXTURE_SHA256 = (
    "408705cbcc2caf2a0d04a766f10a8bbec3cddfe1eca2fa302984181ed54241bd"
)

...
def narrative_semantic_hostiles() -> int:
    ...
    semantic_tokens = (
        ...
        (
            b"all 39 receipt records\ncarry `exit_code: 0`",
            b"all replay commands succeeded",
    ...
    return len(C9.C9_NARRATIVE_PATHS) + 1 + len(targeted) + len(semantic_tokens) + 4
    ...
    try:
        ...
        require(
            ...
            == {
                ...
                "narrative_semantic_hostiles_rejected": 55,
                "policy_hostiles_rejected": 32,
                "rejected_replay_hostiles_rejected": 4,

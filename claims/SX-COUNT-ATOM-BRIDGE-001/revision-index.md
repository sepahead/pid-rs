# Revision index for SX-COUNT-ATOM-BRIDGE-001

| Revision | Claim | Decision | Obligations | Routes | Disposition |
|---:|---|---|---|---|---|
| 1 | [`claim-v1.md`](claim-v1.md) | [`decision-v1.md`](decision-v1.md) | [`obligations.md`](obligations.md) | [`routes.md`](routes.md) | historical superseded pre-integration candidate/hold; no current authority |
...
remain prior execution evidence. Here `r9` denotes only the ninth receipt in the versioned sequence
that originated on 12 August, and therefore the tenth current-project replay receipt overall; the

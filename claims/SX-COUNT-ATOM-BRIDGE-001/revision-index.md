...
remain prior execution evidence. Here `r14` denotes only the fourteenth receipt in the versioned sequence
that originated on 12 August, and therefore the fifteenth current-project replay receipt overall; the

# Revision index for SX-CERTIFIED-AVERAGED-PID2-001

This index is the human entry point for the versioned assurance claim. A later revision does not
rewrite or retroactively strengthen an earlier one.

| Revision | Claim | Decision | Binding | Status |
|---|---|---|---|---|

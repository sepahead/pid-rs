...
| P0-06 quantization | fitted quantizer; finite in-range nondecreasing edges across ordinary, extreme, constant, signed-zero, adjacent, and narrow ranges; nominal/map-reachable/observed label and joint-cell diagnostics; three domain-separated training-input/transform-input/categorical-output hashes; immutable Python labels; held-out tests | Rust/Python fixture parity, including noncontiguous reachable labels and cardinality overflow |
